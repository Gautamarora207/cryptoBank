...
const LoremTwoPage: React.FC = () => {
  return (
    <>
      <Typography color="primary" variant="h3" mb={4}>
        Page Two
      </Typography>
      ...
      <Typography variant="body2" component="p" mb={4}>
        ...
        dolorum blanditiis ipsam ullam quibusdam iusto quaerat labore porro
        rerum sit rem beatae quas. Eius, magni nam impedit provident id, autem
        officia voluptatum unde fuga voluptatem pariatur quis deleniti sit
        veritatis optio, incidunt eum quibusdam ducimus? Repellat molestias modi
      ...
      <Typography variant="body2" component="p" mb={4}>
        ...
        consectetur et vitae ipsam, saepe culpa, atque amet laboriosam repellat.
        Similique harum incidunt fugiat voluptates quibusdam dolore deleniti
